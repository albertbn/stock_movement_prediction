...
TWEET_EMBEDDING_DIM = 16


class ModelCnnNoTweets(DataScale):
    ...
    def __init__(self):
        ...
        self.model = StockCNN(NUM_NUMERICAL_COLS).to(self.device)
...
class StockCNN(nn.Module):
    ...
    def forward(self, src_data: torch.Tensor, src_symbol: torch.Tensor, src_tweet: torch.Tensor):
        ...
        # x = torch.cat((src_data, self.dropout(src_tweet)), dim=-1)
        x = src_data
